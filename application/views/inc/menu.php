...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php } else { ?>
            ...
            <li class="nav-item">
                <a href="" class="nav-link <?= ($page == 'surat_masuk' || $page == 'surat_keluar')  && $page2 == 'report' ? "active" : null ?>">
                ...
                <ul class="nav nav-treeview" <?= ($page == 'surat_masuk' || $page == 'surat_keluar')  && $page2 == 'report'  ? 'style="display: block;"' : null ?>>
                    <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="" class="nav-link <?= $page == 'dokumen' && ( $page2 == 'edaran' || $page2 == 'kebijakan') ? "active" : null ?>">
                ...
                <ul class="nav nav-treeview" <?= $page == 'dokumen' && ( $page2 == 'edaran' || $page2 == 'kebijakan') ? 'style="display: block;"' : null ?>>
                    <li class="nav-item">
                        <a href="<?= site_url('dokumen/kebijakan') ?>" class="nav-link <?= $page == 'dokumen' && $page2 == 'kebijakan' ? "active" : null ?>" >
                            <i class="far fa-circle nav-icon"></i>
                            <p>Kebijakan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= site_url('dokumen/edaran') ?>" class="nav-link <?= $page == 'dokumen' && $page2 == 'edaran' ? "active" : null ?>">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Edaran</p>
                        </a>
                    </li>
