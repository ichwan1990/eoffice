		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				echo form_open_multipart('surat_keluar/proses', $attr); ?>
					...
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-xs-12">Pengolah *</label>
					...
					<div class="form-group">
						...
						<div class="col-md-5 col-sm-6 col-xs-12">
							<textarea name="isi" class="form-control col-md-7 col-xs-12" rows="5" required><?=$row->isi_ringkas?></textarea>
						</div>
					</div>
					<div class="form-group">
				...
				function set_nosurat() {
					...
					var no_surat = kategori+'/'+no_agenda+'/'+pengolah+'/'+year;
