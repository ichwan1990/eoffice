			...
			<div class="x_content">
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-sm-3 col-xs-12">
						...
						<input type="number" name="no_agenda" class="form-control col-md-6 col-xs-12" value="<?= $row->no_agenda ?>" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">Tanggal Penyelesaiaan</label>
					<div class="col-md-3 col-sm-4 col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-6 col-xs-12">
						<textarea name="isi" class="form-control col-md-6 col-xs-12" rows="5" required><?= $row->isi_ringkas ?></textarea>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-6 col-xs-12">
						<div class="radio">
							<label>
								<input type="radio" value="Biasa" name="sifat" required <?= $row->sifat_surat == "Sangat Segera" ? "checked" : null ?>> Biasa
							</label>
						</div>
						<div class="radio">
							<label>
