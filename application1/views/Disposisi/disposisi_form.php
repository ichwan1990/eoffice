					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<label>
									<input type="radio" value="1" name="input_teruskan" id="input_teruskan1" required <?= $row->input_teruskan == "1" || $row->input_teruskan == null ? "checked" : null ?>> Diteruskan kepada Sdr. :
								</label>
								<?php
								$no = 1;
								if ($tujuan != null) {
								...
								<div class="checkbox" style="margin-left: 15px;">
									<label>
										<input type="checkbox" name="tujuan[]" id="tujuan-3" class="tujuan" value="29">Kabid Administrasi </br>ANDRI SUPANINGRUM,S.E
									</label>
								</div>
							</div>
							<div class="form-group">
