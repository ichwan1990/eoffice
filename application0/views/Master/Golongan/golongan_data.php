						...
						foreach ($row as $r => $data) { ?>
							<tr>
								...
								<td class="text-center">
									...
									<a href="<?=site_url('golongan/del/'.$data->id_gol)?>" onclick="return confirm('Apakah Anda yakin?')"  class="btn btn-xs btn-danger" title="Delete"><i class="fa fa-trash-o"></i></a>
					            </td>
							</tr>
						<?php } ?>
					</tbody>
