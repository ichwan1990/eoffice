			...
			<div class="x_content">
				<form action="<?=site_url('kategori_surat/proses')?>" method="post" class="form-horizontal form-label-left" autocomplete="off">
					<div class="form-group">
						<label class="control-label col-sm-4 col-xs-12">Kode Kategori <span class="required">*</span></label>
						<div class="col-sm-4 col-xs-12">
							<input type="hidden" name="id" value="<?=$row->id_kategori?>">
							<input type="text" name="kode" class="form-control col-md-7 col-xs-12" value="<?=$row->kode_kategori?>" required>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4 col-xs-12">Nama Kategori <span class="required">*</span></label>
						<div class="col-sm-4 col-xs-12">
							<input type="text" name="nama" class="form-control col-md-7 col-xs-12" value="<?=$row->nama_kategori?>" required>
						</div>
					</div>
					<div class="form-group">
