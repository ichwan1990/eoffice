...
class Surat_keluar extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->session->userdata('level_user') == '1' || $this->session->userdata('level_user') == '2') {
			...
			$data['row'] = $this->surat_out->get2()->result();
		}
	...
	public function no_agenda()
	{
		...
		$Surat_out =  $this->surat_out->no_agenda1($this->input->get('id_pengolah', TRUE))->row()->no + 1;
		$data = str_pad($Surat_out, 3, "0", STR_PAD_LEFT);
		echo $data;
	}
