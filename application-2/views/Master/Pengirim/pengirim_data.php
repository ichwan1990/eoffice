				...
				foreach ($row as $r => $data) { ?>
					<tr>
						...
						<td class="text-center">
							...
							<!-- </div> -->
							<!-- <div> -->
							<a href="<?= site_url('pengirim_surat/del/' . $data->id_pengirim) ?>" onclick="return confirm('Apakah Anda yakin?')" class="btn btn-xs btn-danger" title="Delete"><i class="fa fa-trash"></i></a>
							<!-- </div> -->
						</td>
					</tr>
				<?php } ?>
