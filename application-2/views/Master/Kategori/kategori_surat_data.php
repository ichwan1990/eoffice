				...
				foreach ($row as $r => $data) { ?>
					<tr>
						...
						<td class="text-center">
							...
							<!-- </div> -->
							<!-- <div> -->
							<a href="<?= site_url('kategori_surat/del/' . $data->id_kategori) ?>" onclick="return confirm('Apakah Anda yakin?')" class="btn btn-xs btn-danger" title="Delete"><i class="fa fa-trash"></i></a>
							<!-- </div> -->
						</td>
					</tr>
				<?php } ?>
