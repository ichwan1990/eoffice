                                        ...
                                        <div class="col-md">
                                            ...
                                            if ($this->session->userdata('level_user') == '1') {
                                                ...
                                                <?php
                                                    ...
                                                    <div class="col">
                                                        <a href="<?= site_url('disposisi/' . $data->id_surat_in) ?>" target="_blank" class="btn btn-xs btn-warning"><i class="fa fa-file"></i> Lihat Disposisi</a>
                                                    </div>
                                                <?php
                                                }
                                            } else {
                                                ...
                                                <?php
                                                    ...
                                                    <div class="col">
                                                        <a href="<?= site_url('disposisi/' . $data->id_surat_in) ?>" class="btn btn-xs btn-warning"><i class="fa fa-file"></i> Lihat Disposisi</a>
                                                    </div>
                                            <?php
                                                }
                                            }
